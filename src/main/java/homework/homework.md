...
3. Для генерации случайных чисел используйте встроенный класс [`Random`](https://github.com/Gangster177/pattern3Iterator/blob/main/src/main/java/homework/Randoms.java#L19)
